  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center space-y-20 sm:space-y-8">
      <div className="w-full flex relative pl-5  sm:pl-10 md:pl-24 justify-center flex-col font-roboto font-light    mb-5 text-white ">
        ...
        <h1 className="z-10 text-white introduction opacity-0 font-[100] sm:pt-3 opacity-1 introduction  max-w-5xl translate-y-10 leading-[0.9] sm:leading-[0.9]  text-[40px] customsm:text-[56px] sm:text-[72px] md:text-[90px] md:leading-[0.9]   font-playfair ">
       ...
       hi, I am <span className="font-normal">Aman Shrestha</span>, an inquisitive software engineer based in Nepal. With a keen eye for detail and a passion for problem-solving, I strive to create elegant, user-friendly solutions that exceed expectations.
