...
const Contact = () => {
  return (
    <div className="customsm:min-h-screen z-10 flex items-center px-2 py-10 justify-center">
      <div className="box border-white border-2 py-16 overflow-hidden rounded-[36px] sm:rounded-[56px] flex flex-col space-y-1 items-center px-10 sm:px-32 justify-center relative">
