...
const WorkComponent = ({imgurl, desc, worklink}) => {
  return (
    <div className="flex flex-col space-y-1">
          <div className="w-full sm:hover:scale-105  duration-700 max-w-4xl min-w-[314px] customsm:min-w-[340px] rounded-2xl  customsm:rounded-[24px] h-[450px]   relative overflow-y-hidden ">
            <a href={worklink}>
