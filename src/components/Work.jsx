  ...
  return (
    <div className="min-h-screen flex flex-col px-2 justify-center item-center w-full">
      ...
      <div className="flex  items-center  overflow-y-auto scrollbar-hide   py-10  gap-8 pt-10 customsm:px-10 z-20 lg:px-24">
        <div className="w-full hover:h-[560px] hover:w-[110%] duration-700 max-w-4xl min-w-[314px] customsm:min-w-[360px]  rounded-[44px] h-[460px]  customsm:h-[520px] relative overflow-y-hidden ">
          <a href="https://urban-dwellings.vercel.app/">
            <img className=" " src="/urban.png" alt="Urban Dwellings" />
          </a>
        </div>

        <div className="w-full max-w-4xl hover:h-[560px] hover:w-[110%]  duration-700 min-w-[314px] customsm:min-w-[360px] rounded-[44px]  h-[460px]  customsm:h-[520px] relative  overflow-hidden ">
